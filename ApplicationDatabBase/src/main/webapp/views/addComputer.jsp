...
<body>
    <header class="navbar navbar-inverse navbar-fixed-top">
        <div class="container">
            <a class="navbar-brand" href="http://localhost:8080/ApplicationDatabBase/menu"> Application - Computer Database </a>
        </div>
    </header>
                ...
                <div class="col-xs-8 col-xs-offset-2 box">
                    ...
                    <form action="addComputer" method="POST">
                        ...
                        <div class="actions pull-right">
                            ...
                            or
                            <a href="http://localhost:8080/ApplicationDatabBase/menu" class="btn btn-default">Cancel</a>
                        </div>
                    </form>
                </div>
            </div>
